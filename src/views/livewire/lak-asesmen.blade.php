	...
	<div class="col-md-6">
		...
		<div class="card card-primary">
			...
			<div class="card-body">
				<ul class="list-group">
				  <li class="list-group-item d-flex justify-content-between align-items-center">
					<a href="javascript:void(0)" onclick="window.open('{{ route('berita-acara-pengguna', $uAsesmen->id)  }}', 'ikami-preview', 'height=800,width=600')">Berita Acara</a>
				  </li>
			  </ul>
			</div>
		</div>
...
@push('js')
	...
	<script>
		...
		function upgrade()
		{
			var val = prompt('Silakan ketik: desktop-assessment')
			return val =='desktop-assessment'
		}
